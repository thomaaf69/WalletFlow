...
#[derive(Debug)]
pub struct WalletFlowProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WalletFlowProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WalletFlow processing");
    
    let mut processor = WalletFlowProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WalletFlowProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WalletFlowProcessor::new(false);
